  ...
  <form method = "post" action="" enctype="multipart/form-data">
	...
	<table align="left" width="70%">
	  ...
	  <tr>
	   ...
	   <td colspan="3">
	   <?php include('users/edit_state_list.php');?>
	   </td>
	  </tr>
	  ...
	  <tr>
	   ...
	   <td colspan="3"><input type="tel" name="contact" value="<?php echo $fetch_user['contact'];?>" required placeholder="Contact" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"/></td>
	  </tr>
...
if(isset($_POST['edit_profile'])){  
  ...
  if($_POST['name'] !='' && $_POST['edit_state'] !='' && $_POST['city'] !='' && $_POST['contact']!='' && $_POST['address']!='' ){
   ...
   $update_profile = mysqli_query($con,"update users set name='$name', state='$state', city='$city', contact='$contact', user_address='$address' where id='$_SESSION[user_id]'");
