  ...
  <div class="receipt_info_box">
   ...
   <div class="receipt_info_left">
    ...
    <div class="receipt_info_left_box">
     ...
     <p><?php echo $fetch_buyer['state']; ?></p>
...
<table>
 ...
 <tbody>
  <tr>
    ...
    <td><small><?php echo $fetch_multi_payments['date']; ?></small></td>
    <td align="center"><?php echo $fetch_multi_payments['quantity']; ?></td>
    <td><small><b>RM <?php echo $fetch_multi_payments['product_price']; ?></b></small></td>
